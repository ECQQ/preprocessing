...
WHERE 
	...
	w.word_1 IN 
		(SELECT tnw.word_1 from top_country_need_exp_dialogues as tnw where tnw.macro = n.macro) AND
	w.word_2 IN (SELECT tnw.word_1 from top_country_need_exp_dialogues as tnw where tnw.macro = n.macro)
